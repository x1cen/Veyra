...
//                });
    ...
    private void applyContactToPhoneBook(ArrayList<ContentProviderOperation> query, TLRPC.User user) {
        ...
        builder.withValue(ContactsContract.RawContacts.ACCOUNT_TYPE, BuildVars.BUILD_DUROV_TG);
        ...
        builder.withValue(ContactsContract.Data.MIMETYPE, "vnd.android.cursor.item/vnd.org.telegram.messenger.web.profile");
        ...
        builder = ContentProviderOperation.newInsert(ContactsContract.Data.CONTENT_URI);
        builder.withValueBackReference(ContactsContract.Data.RAW_CONTACT_ID, rawContactId);
        builder.withValue(ContactsContract.Data.MIMETYPE, "vnd.android.cursor.item/vnd.org.telegram.messenger.web.call");
        builder.withValue(ContactsContract.Data.DATA1, user.id);
        ...
        builder = ContentProviderOperation.newInsert(ContactsContract.Data.CONTENT_URI);
        builder.withValueBackReference(ContactsContract.Data.RAW_CONTACT_ID, rawContactId);
        builder.withValue(ContactsContract.Data.MIMETYPE, "vnd.android.cursor.item/vnd.org.telegram.messenger.web.call.video");
        builder.withValue(ContactsContract.Data.DATA1, user.id);
    ...
    public void createOrUpdateConnectionServiceContact(long id, String firstName, String lastName) {
        ...
        try {
            ...
            Cursor cursor = resolver.query(groupsURI, new String[]{ContactsContract.Groups._ID},
                    ...
                    new String[]{"TelegramConnectionService", BuildVars.BUILD_DUROV_TG, String.valueOf(UserConfig.getInstance(currentAccount).getClientUserId())}, null);
            int groupID;
            if (cursor != null && cursor.moveToFirst()) {
                ...
                ContentValues values = new ContentValues();
                values.put(ContactsContract.Groups.ACCOUNT_TYPE, BuildVars.BUILD_DUROV_TG);
            ...
            if (cursor != null && cursor.moveToFirst()) {
                ...
                ops.add(ContentProviderOperation.newInsert(rawContactsURI)
                        .withValue(ContactsContract.RawContacts.ACCOUNT_TYPE, BuildVars.BUILD_DUROV_TG)
